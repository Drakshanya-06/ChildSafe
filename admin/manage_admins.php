    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col hidden md:flex">
            ...
            <nav class="flex-1 py-4">
                ...
                <a href="manage_admins.php" class="flex items-center px-6 py-3 bg-gray-800 text-white border-l-4 border-[#b1d3b9]">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <form action="manage_admins.php" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="username" required class="w-full rounded border-gray-300 shadow-sm p-2 border focus:ring-[#b1d3b9] focus:border-[#b1d3b9]">
                            </div>
                            <div class="mb-6">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                                <input type="password" name="password" required class="w-full rounded border-gray-300 shadow-sm p-2 border focus:ring-[#b1d3b9] focus:border-[#b1d3b9]">
                            </div>
                            <button type="submit" class="w-full bg-[#b1d3b9] text-white font-bold py-2 px-4 rounded hover:bg-blue-700 transition">Create Administrator</button>
                        </form>
                    </div>
                </div>
